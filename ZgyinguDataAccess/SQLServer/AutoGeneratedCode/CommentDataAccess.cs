...
namespace Zkjj.Zgyinggu.DataAccess.SQLServer
{
	...
	public class CommentDataAccessBase
	{
		...
		{
			string commandName = "dbo.Pr_Comment_Insert";
			...
			dataDebugInfo.AppendLine().Append("(").Append(parms[1].Direction.ToString()).Append(")").Append("CommentContent: ").Append(parms[1].Value);
			dataDebugInfo.AppendLine().Append("(").Append(parms[2].Direction.ToString()).Append(")").Append("SubjectId: ").Append(parms[2].Value);
		...
		{
			string commandName = "dbo.Pr_Comment_Delete";
		...
		{
			string commandName = "dbo.Pr_Comment_Update";
		...
		public virtual Comment GetById(Int32 id)
		{
			...
			string commandName = "dbo.Pr_Comment_GetByPk";
		...
		public virtual CommentList GetPagedListAll(int startRowIndex, int maximumRows, string sortExpression, out int totalRecords)
		{
			...
			string commandName = "dbo.Pr_Comment_GetPagedListAll";
